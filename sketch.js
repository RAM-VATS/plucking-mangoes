...
function setup() {
	...
	dground=new Ground();
	stones=new Stone(100,450,50);
	mango1=new Mango(600,290,50);
	mango2=new Mango(855,325,50);
	mango3=new Mango(670,260,50);
	mango4=new Mango(730,200,50);
	mango5=new Mango(710,320,50);
	mango6=new Mango(780,250,50);
	mango7=new Mango(825,170,50);
	mango8=new Mango(880,260,50);
	mango9=new Mango(940,220,50);
	mango10=new Mango(980,305,50);
